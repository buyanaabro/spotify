  ...
  return (
    <div className="w-60 h-full fixed bg-black left-0 flex flex-col items-center space-y-5">
      ...
      <div className="w-50 h-20 space-y-3 mr-6">
        <button className="w-40 h-7 mt-3 flex items-center flex-row text-gray-400 hover:text-white duration-300 font-medium">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          <div className="ml-4 text-sm">Create playlist</div>
        </button>
