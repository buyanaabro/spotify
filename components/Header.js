...
export default function Header() {
  ...
  return (
    <div className={opacity ? "w-full h-16 fixed bg-black flex flex-row items-center duration-500" : "w-full h-16 fixed flex flex-row items-center duration-500"}>
