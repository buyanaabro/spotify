    ...
    <div className='w-screen overflow-x-hidden h-[380vh]'>
                ...
                <div className='flex flex-col mt-4'>
                  {data[0].duu.slice(0, 5).map((row, index) => (
                        <ol className='relative left-20 flex items-center text-white' key={index}>
                          ...
                          <li className='w-96 m-4 cursor-pointer hover:underline'>{row.songName}</li>
                          <li className='text-gray-400 font-light text-sm ml-72'>{randomNumber}</li>
                        </ol>
                      ))}
                </div>
        ...
        <div className='flex flex-col justify-center w-[85.7vw] h-[40vh] bg-[#121212] relative left-[14.3vw]'>
          <div className="flex items-center justify-between">
            ...
            <div className="text-gray-400 text-sm font-semibold mr-6 cursor-pointer hover:underline">See discography</div>
          </div>
          <div className='w-full h-full grid grid-cols-5 gap-5 ml-4'>
            {data[0].duu.slice(3, 8).map((row, index) => (
              <Song_Card key={index} row={row} />
        ...
        <div className='flex flex-col justify-center w-[85.7vw] h-[40vh] bg-[#121212] relative left-[14.3vw]'>
          <div className="flex items-center justify-between">
            <div className='text-white text-2xl font-semibold mr-6 ml-6 mb-6'>Featuring {data[0].singer}</div>
            <div className="text-gray-400 text-sm font-semibold mr-6 cursor-pointer hover:underline">See discography</div>
          </div>
          <div className='w-full h-full grid grid-cols-5 gap-5 ml-4'>
            {data[0].duu.slice(3, 8).map((row, index) => (
        ...
        <div className='flex flex-col justify-center w-[85.7vw] h-[40vh] bg-[#121212] relative left-[14.3vw]'>
          <div className="flex items-center justify-between">
            <div className='text-white text-2xl font-semibold mr-6 ml-6 mb-6'>Fans also like</div>
            <div className="text-gray-400 text-sm font-semibold mr-6 cursor-pointer hover:underline">See discography</div>
          </div>
          <div className='w-full h-full grid grid-cols-5 gap-5 ml-4'>
