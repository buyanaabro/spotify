...
export default function ArtistDetails() {
  ...
  return (
    <div className="w-screen overflow-x-hidden h-[200vh]">
      <main className="right-0 w-full h-[95vh] flex flex-col items-end bg-[#121212]">
        <div
        ...
        <songs className="w-[87vw] h-[55vh] flex">
          <div className="w-[80%] flex flex-col">
            <div className="w-[30%] h-[20%] flex flex-row justify-center items-center ml-8">
              <Image
              ...
              <div
                ...
                className={
                  followStyle
                    ? "w-32 h-8 ml-[-9.05%] flex justify-center items-center rounded-md tracking-widest font-semibold border-[1px] border-white text-white text-xs cursor-default"
              ...
              {data[0].duu.slice(0, 5).map((row, index) => (
                ...
                >
                  ...
                  <Image
                    ...
                    height={0}
                  />
                  <li className="w-40 m-6 cursor-pointer hover:underline">
                    {row}
                  </li>
                  <li className="text-gray-400 font-light text-sm ml-[45%]">
                    {randomNumber}
                  </li>
                </ol>
              ))}
        ...
        <div className="text-gray-400 relative text-sm font-semibold right-[79%] bottom-[6%] cursor-default">
          See more
        </div>
      </main>
      <Header />
